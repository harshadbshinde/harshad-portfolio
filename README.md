...
Provisioned an AWS EKS infrastructure using Terraform.
...
- Created AWS VPC infrastructure using Terraform
- Configured public and private subnets
- Created IAM roles and policies
- Provisioned Amazon EKS
- Configured worker nodes
- Configured AWS VPC CNI
- Implemented Kubernetes NetworkPolicies
- Configured Amazon EFS CSI Driver
